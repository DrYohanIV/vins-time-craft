...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-D3LcrA-T.mjs");
...
const manifest = {
  "a6485a0caa6c7276b8f38fd2e39c7cd965ae3addca5ff318987f97661206380a": {
    ...
    importer: () => import("./orders.functions-Dy7s6FiV.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BI-Nvu9e.mjs").then((n) => n.r),
    import("./start-D6HBmMEv.mjs"),
