...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-4fyYj8Fy.mjs");
...
const manifest = {
  "a6485a0caa6c7276b8f38fd2e39c7cd965ae3addca5ff318987f97661206380a": {
    ...
    importer: () => import("./orders.functions-BCNfELIE.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DU_JEXVw.mjs").then((n) => n.r),
    import("./start-Dg6-8epH.mjs"),
