...
const $$splitComponentImporter$k = () => import("./shop-CxpgzrNS.mjs");
...
const $$splitComponentImporter$j = () => import("./contact-thbEdsjE.mjs");
...
const $$splitComponentImporter$i = () => import("./checkout-BD1ClY-g.mjs");
const Route$i = createFileRoute("/checkout")({
  component: lazyRouteComponent($$splitComponentImporter$i, "component")
});
const $$splitComponentImporter$h = () => import("./cart-Dh038WF3.mjs");
const Route$h = createFileRoute("/cart")({
  component: lazyRouteComponent($$splitComponentImporter$h, "component")
});
const $$splitComponentImporter$g = () => import("./auth-_qXGrHVN.mjs");
...
const $$splitComponentImporter$e = () => import("../_authenticated-B9JOa34W.mjs");
const Route$e = createFileRoute("/_authenticated")({
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./index-CeeETyXm.mjs");
...
const $$splitComponentImporter$c = () => import("./watch._id-CoLjQL8A.mjs");
const Route$c = createFileRoute("/watch/$id")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./admin-BYtgJNaw.mjs");
const Route$b = createFileRoute("/_authenticated/admin")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./account-a-x8LAI6.mjs");
const Route$a = createFileRoute("/_authenticated/account")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./index-mgXZLvji.mjs");
const Route$9 = createFileRoute("/_authenticated/admin/")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./watches-CQu28WcJ.mjs");
const Route$8 = createFileRoute("/_authenticated/admin/watches")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./promotions-CdfilknM.mjs");
